...
status_t MMParserSource::read(
    ...
    *out = NULL;
    ...
    if (options && options->getSeekTo(&seekTimeUs, &seekMode)) {
        ...
        LOGV("MMParserSource::read Seek seekTimeUs = %lld, seekMode %d",seekTimeUs,seekMode);
        ...
        LOGV("MMParserSource::read Seek seekTimems = %lu, mTrackId = %d", seekTimems,mTrackId);
