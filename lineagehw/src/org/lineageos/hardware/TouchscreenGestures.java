...
private static final String[] GESTURE_PATHS = {
    "/proc/touchpanel/letter_c_enable",
        "/proc/touchpanel/swipe_up_enable",
        "/proc/touchpanel/swipe_right_enable",
        "/proc/touchpanel/swipe_down_enable",
        "/proc/touchpanel/swipe_left_enable",

};
    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "Letter C", 250),
        new TouchscreenGesture(1, "One finger up swipe", 66),
        new TouchscreenGesture(2, "One finger right swipe", 65),
        new TouchscreenGesture(3, "One finger down swipe", 64),
        new TouchscreenGesture(4, "One finger left swipe", 63),
};
    /**
