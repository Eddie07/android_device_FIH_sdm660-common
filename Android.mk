...
SFS_FIRMWARE_MOUNT_POINT := $(TARGET_OUT_VENDOR)/securefs
DSP_MOUNT_POINT := $(TARGET_OUT_VENDOR)/dsp
FSG_MOUNT_POINT := $(TARGET_OUT_VENDOR)/fsg

ALL_DEFAULT_INSTALLED_MODULES += $(FIRMWARE_MOUNT_POINT) \
	$(BT_FIRMWARE_MOUNT_POINT) \
	$(SFS_FIRMWARE_MOUNT_POINT) \
	$(DSP_MOUNT_POINT) \
	$(FSG_MOUNT_POINT)
...
$(SFS_FIRMWARE_MOUNT_POINT):
	@echo "Creating $(SFS_FIRMWARE_MOUNT_POINT)"
	@mkdir -p $(TARGET_OUT_VENDOR)/securefs
ifneq ($(TARGET_MOUNT_POINTS_SYMLINKS),false)
	@ln -sf /vendor/securefs $(TARGET_ROOT_OUT)/securefs
endif
...
GLES_SYMLINK := $(TARGET_OUT_VENDOR)/lib/egl/libGLESv2_adreno.so

$(GLES_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /vendor/lib/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(EGL_SYMLINK) $(GLES_SYMLINK)
